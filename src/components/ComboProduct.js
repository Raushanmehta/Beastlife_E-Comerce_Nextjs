...
const ProductSlider = () => {
  ...
  return (
    <div className=' bg-[#F6F6F6]'>
      <div className='flex items-center md:px-20 m-4'>
      ...
      <section className="relative overflow-hidden bg-[#F6F6F6] p-4 md:px-32">
        <div className="flex flex-col items-center">
          <ul className="flex overflow-x-auto snap-x snap-mandatory space-x-4 scroll-hidden" ref={trackRef}>
            {productData.map((product, index) => (
              <li key={index} className="flex-shrink-0 w-1/3"> 
