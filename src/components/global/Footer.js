      ...
      <footer className="bg-black text-white pt-8 md:pt-12 relative">
        <div className="px-4 md:px-24 ">
          <div className="flex flex-col  md:items-start">
            ...
            <p className=" md:text-left mb-4 md:mt-2 text-xl">
          ...
          <div className="w-full lg:w-1/5 sm:w-1/2 lg-p-4 mt-6">
                ...
                <div className="footer_menu mt-4">
                  <ul className=" text-xl md:text-base mt-2 text-neutral-400">
              ...
              <div className="w-full lg:w-1/5 sm:w-1/2 lg-p-4 mt-6">
                <h2 className="text-2xl text-[#BDDD01] md:text-white">Explore</h2>
                <div className="footer_menu mt-4">
                  <ul className="text-xl md:text-base mt-2 text-neutral-400">
        ...
        <div className=" absolute text-[#BDDD01] md:right-0 -right-16 mt-[-390px] md:mt-[-230px]">
              <Image src="/assets/footer-panther.svg"height={350} width={350}alt="sheru" className=""/>
              </div> 
        <p className="text-center items-center copyright py-8">Copyright © 2024 BeastLife. All Rights Reserved.</p>  
      </footer>
    </div>
  );
};
